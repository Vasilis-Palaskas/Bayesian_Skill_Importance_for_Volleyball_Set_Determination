...
data_zdts_ta_skills<-list(c_thres=2,c_std=9,
...
save(ZDTS_TA_Skills_after_BVS,file="std_9_revised_ZDTS_TA_Skills_after_BVS")
...
waic(log_lik_ZDTS_TA_Skills_after_BVS)####   255.1 19.2
loo(log_lik_ZDTS_TA_Skills_after_BVS,
    r_eff=r_eff_log_lik_ZDTS_TA_Skills_after_BVS)#  259.7 19.7
DIC_Gelman(deviance_ZDTS_TA_Skills_after_BVS)# 255.6031
