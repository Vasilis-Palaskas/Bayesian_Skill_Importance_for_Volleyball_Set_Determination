...
setwd("C:/Users/vasileios palaskas/Desktop/Github folder/Bayesian_Variable_Selection_Volleyball/Section_5_2_BVS_ZDTS/With_both_skill_actions_team_abilities")
...
###----Betas home
pdf(file="cumul_plots_betas_home_bvs_zdts_ta_skills.pdf", width =16, height =9)
...
###----Betas away
pdf(file="cumul_plots_betas_away_bvs_zdts_ta_skills.pdf", width =16, height =9)
...
###----gammas home
pdf(file="cumul_plots_gammas_home_bvs_zdts_ta_skills.pdf", width =16, height =9)
...
###----gammas away
pdf(file="cumul_plots_gammas_away_bvs_zdts_ta_skills.pdf", width =16, height =9)
