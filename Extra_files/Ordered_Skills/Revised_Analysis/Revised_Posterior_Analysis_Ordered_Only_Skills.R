...
setwd("C:/Users/vasileios palaskas/Desktop/Github folder/Bayesian_Variable_Selection_Volleyball/Ordered_Skills/Revised_Analysis")
...
DIC_Gelman(deviance_ordered_skills_after_BVS_model)#245.3
...
names(ordered_skills_after_BVS_model)[1:9]<-skill_events_differences
