...
#--Selected covariates via the Gibbs BVS Method (standardized)

final_X_home_std<-X_home_std[,colnames(X_home_std)%in%c("Home_perfect_passes_std","Home_very_good_passes_std",
                                                        "Home_poor_passes_std","Home_failed_passes_std",
                                                        "Home_blocked_att1_std")]

final_X_away_std<-X_away_std[,colnames(X_away_std)%in%c("Away_failed_serves_std",
...
setwd("C:/Users/vasileios palaskas/Desktop/Github folder/Bayesian_Variable_Selection_Volleyball/ZDTS_Skills/Sections 4.3-4.5")
load("C:\\Users\\vasileios palaskas\\Dropbox\\Egidi_Ntzoufras_Palaskas_Drikos_BVS1 Paper\\Models_Outputs_4_5_sections\\ZDTS\\Skills\\ZDTS_only_Skills_after_BVS")#"ZDTS_only_Skills_after_BVS"
...
names(ZDTS_only_Skills_after_BVS)[1:5]<-c("(Home) perfect passes",
                                          "(Home) very good passes",
                                          "(Home) poor passes",
                                          "(Home) failed passes",
                                          "(Home) blocked att1")
...
lambda1_star_away_params_final_ZDTS_paper.v1<-params_final_ZDTS_paper.v1$lambda1_star
...
avg_lambda1_star_away_params_final_ZDTS_paper.v1<-apply(lambda1_star_away_params_final_ZDTS_paper.v1,2,mean)
...
data_by_sets$Home_perfect_passes_coef<-avg_beta_home_params_final_ZDTS_paper.v1[1]
data_by_sets$Home_very_good_passes_coef<-avg_beta_home_params_final_ZDTS_paper.v1[2]
data_by_sets$Home_poor_passes_coef<-avg_beta_home_params_final_ZDTS_paper.v1[3]
data_by_sets$Home_failed_passes_coef<-avg_beta_home_params_final_ZDTS_paper.v1[4]
data_by_sets$Home_blocked_att1_coef<-avg_beta_home_params_final_ZDTS_paper.v1[5]
...
data_by_sets$avg_lambda1_star<-avg_lambda1_star_away_params_final_ZDTS_paper.v1
...
home_athletes_skills_coefs<-c("home_Team",paste0("Home_",c("Player.x","Position.x",
                                                           "perfect_passes.x","very_good_passes.x",
                                                           "poor_passes.x","failed_passes.x",
                                                           "blocked_att1.x",
                                                           "perfect_passes_coef","very_good_passes_coef",
                                                           "poor_passes_coef","failed_passes_coef",
                                                           "blocked_att1_coef")),
                              "avg_lambda1_star","away_Team"
)
...
away_athletes_skills_coefs<-c("away_Team",paste0("Away_",c("Player.y","Position.y",
                                                           ...
                                                           "blocked_net_violation_coef","failed_blocks_coef")),"avg_lambda2_star"
                              ,"home_Team" )
...
#----Standardisation
home_skills_std$Home_perfect_passes.x_std<-(home_data_by_sets_athletes_distinct$Home_perfect_passes.x-mean(X_home$Home_perfect_passes))/
  sd(X_home$Home_perfect_passes)
home_skills_std$Home_very_good_passes.x_std<-(home_data_by_sets_athletes_distinct$Home_very_good_passes.x-mean(X_home$Home_very_good_passes))/
  sd(X_home$Home_very_good_passes)
home_skills_std$Home_poor_passes.x_std<-(home_data_by_sets_athletes_distinct$Home_poor_passes.x-mean(X_home$Home_poor_passes))/
  sd(X_home$Home_poor_passes)
home_skills_std$Home_failed_passes.x_std<-(home_data_by_sets_athletes_distinct$Home_failed_passes.x-mean(X_home$Home_failed_passes) )/
  sd(X_home$Home_failed_passes)
home_skills_std$Home_blocked_att1.x_std<-(home_data_by_sets_athletes_distinct$Home_blocked_att1.x-mean(X_home$Home_blocked_att1))/
  sd(X_home$Home_blocked_att1)

#- Convert it to a dataframe
home_skills_std<-data.frame(Home_perfect_passes.x_std=home_skills_std$Home_perfect_passes.x_std,
                            Home_very_good_passes.x_std=home_skills_std$Home_very_good_passes.x_std,
...
away_skills_std$Away_failed_serves.y_std<-(away_data_by_sets_athletes_distinct$Away_failed_serves.y-mean(X_away$Away_failed_serves))/
  sd(X_away$Away_failed_serves)

away_skills_std$Away_failed_passes.y_std<-(away_data_by_sets_athletes_distinct$Away_failed_passes.y-mean(X_away$Away_failed_passes))/
  sd(X_away$Away_failed_passes)

away_skills_std$Away_perfect_att2.y_std<-(away_data_by_sets_athletes_distinct$Away_perfect_att2.y-mean(X_away$Away_perfect_att2))/
  sd(X_away$Away_perfect_att2)

away_skills_std$Away_failed_att2.y_std<-(away_data_by_sets_athletes_distinct$Away_failed_att2.y-mean(X_away$Away_failed_att2))/
  sd(X_away$Away_failed_att2)

away_skills_std$Away_blocked_att1.y_std<-(away_data_by_sets_athletes_distinct$Away_blocked_att1.y-mean(X_away$Away_blocked_att1))/
  sd(X_away$Away_blocked_att1)

away_skills_std$Away_failed_att1.y_std<-(away_data_by_sets_athletes_distinct$Away_failed_att1.y-mean(X_away$Away_failed_att1))/
  sd(X_away$Away_failed_att1)

away_skills_std$Away_net_violation_blocks.y_std<-(away_data_by_sets_athletes_distinct$Away_net_violation_blocks.y-mean(X_away$Away_net_violation_blocks))/
  sd(X_away$Away_net_violation_blocks)

away_skills_std$Away_failed_blocks.y_std<-(away_data_by_sets_athletes_distinct$Away_failed_blocks.y-mean(X_away$Away_failed_blocks))/
...
head(away_data_by_sets_athletes_distinct)
for (i in 1:(dim(home_data_by_sets_athletes_distinct)[1]) ){
  # home_athletes_skills_coefs<-c("home_Team",paste0("Home_",c("Player.x","Position.x",
  #                                                            "perfect_passes.x","very_good_passes.x",
  #                                                            "poor_passes.x","failed_passes.x",
  #                                                            "blocked_att1.x",
  ...
  # )
  #---Standardised coef
  multiplication_home_skills_coefs_per_player_std[i]<-home_data_by_sets_athletes_distinct_based_std$Home_perfect_passes_coef[i]*
    home_data_by_sets_athletes_distinct_based_std$Home_perfect_passes.x_std[i]+
    home_data_by_sets_athletes_distinct_based_std$Home_poor_passes_coef[i]*
    home_data_by_sets_athletes_distinct_based_std$Home_poor_passes.x_std[i]+
    home_data_by_sets_athletes_distinct_based_std$Home_failed_passes_coef[i]*
    home_data_by_sets_athletes_distinct_based_std$Home_failed_passes.x_std[i]+
    home_data_by_sets_athletes_distinct_based_std$Home_blocked_att1_coef[i]*
    home_data_by_sets_athletes_distinct_based_std$Home_blocked_att1.x_std[i]+
    home_data_by_sets_athletes_distinct_based_std$Home_very_good_passes_coef[i]*
    home_data_by_sets_athletes_distinct_based_std$Home_very_good_passes.x_std[i]
  #--- Non Standardised coef
  multiplication_home_skills_coefs_per_player[i]<-home_data_by_sets_athletes_distinct_based_std$Home_perfect_passes_coef[i]*
    home_data_by_sets_athletes_distinct_based_std$Home_perfect_passes.x[i]+
    home_data_by_sets_athletes_distinct_based_std$Home_poor_passes_coef[i]*
    home_data_by_sets_athletes_distinct_based_std$Home_poor_passes.x[i]+
    home_data_by_sets_athletes_distinct_based_std$Home_failed_passes_coef[i]*
    home_data_by_sets_athletes_distinct_based_std$Home_failed_passes.x[i]+
    home_data_by_sets_athletes_distinct_based_std$Home_blocked_att1_coef[i]*
    home_data_by_sets_athletes_distinct_based_std$Home_blocked_att1.x[i]+
    home_data_by_sets_athletes_distinct_based_std$Home_very_good_passes_coef[i]*
    home_data_by_sets_athletes_distinct_based_std$Home_very_good_passes.x[i]
}

for (i in 1:(dim(away_data_by_sets_athletes_distinct)[1]) ){
  # 
  # away_skills_std<-data.frame(Away_failed_serves.y_std=away_skills_std$Away_failed_serves.y_std,
  #                             Away_failed_passes.y_std=away_skills_std$Away_failed_passes.y_std,
  #                             Away_perfect_att2.y_std=  away_skills_std$Away_perfect_att2.y_std,
  ...
  multiplication_away_skills_coefs_per_player_std[i]<--(
    away_data_by_sets_athletes_distinct$Away_failed_serves_coef[i]*
      away_data_by_sets_athletes_distinct_based_std$Away_failed_serves.y_std[i]+
      away_data_by_sets_athletes_distinct$Away_failed_passes_coef[i]*
      away_data_by_sets_athletes_distinct_based_std$Away_failed_passes.y_std[i]+
      away_data_by_sets_athletes_distinct$Away_blocked_att1_coef[i]*
      away_data_by_sets_athletes_distinct_based_std$Away_blocked_att1.y_std[i]+
      away_data_by_sets_athletes_distinct$Away_failed_att1_coef[i]*
      away_data_by_sets_athletes_distinct_based_std$Away_failed_att1.y_std[i]+
      away_data_by_sets_athletes_distinct$Away_perfect_att2_coef[i]*
      away_data_by_sets_athletes_distinct_based_std$Away_perfect_att2.y_std[i]+
      away_data_by_sets_athletes_distinct$Away_failed_att2_coef[i]*
      away_data_by_sets_athletes_distinct_based_std$Away_failed_att2.y_std[i]+
      away_data_by_sets_athletes_distinct$Away_blocked_net_violation_coef[i]*
      away_data_by_sets_athletes_distinct_based_std$Away_net_violation_blocks.y_std[i]+
      away_data_by_sets_athletes_distinct$Away_failed_blocks_coef[i]*
      away_data_by_sets_athletes_distinct_based_std$Away_failed_blocks.y_std[i]
  )
  #--- Non Standardised coef
  multiplication_away_skills_coefs_per_player[i]<--(
    away_data_by_sets_athletes_distinct$Away_failed_serves_coef[i]*
      away_data_by_sets_athletes_distinct_based_std$Away_failed_serves.y[i]+
      away_data_by_sets_athletes_distinct$Away_failed_passes_coef[i]*
      away_data_by_sets_athletes_distinct_based_std$Away_failed_passes.y[i]+
      away_data_by_sets_athletes_distinct$Away_blocked_att1_coef[i]*
      away_data_by_sets_athletes_distinct_based_std$Away_blocked_att1.y[i]+
      away_data_by_sets_athletes_distinct$Away_failed_att1_coef[i]*
      away_data_by_sets_athletes_distinct_based_std$Away_failed_att1.y[i]+
      away_data_by_sets_athletes_distinct$Away_perfect_att2_coef[i]*
      away_data_by_sets_athletes_distinct_based_std$Away_perfect_att2.y[i]+
      away_data_by_sets_athletes_distinct$Away_failed_att2_coef[i]*
      away_data_by_sets_athletes_distinct_based_std$Away_failed_att2.y[i]+
      away_data_by_sets_athletes_distinct$Away_blocked_net_violation_coef[i]*
      away_data_by_sets_athletes_distinct_based_std$Away_net_violation_blocks.y[i]+
      away_data_by_sets_athletes_distinct$Away_failed_blocks_coef[i]*
      away_data_by_sets_athletes_distinct_based_std$Away_failed_blocks.y[i]
  )
}  
...
home_data_by_sets_athletes_distinct_skills_coef_multiplication<-cbind(home_data_by_sets_athletes_distinct_both_original_stds,
                                                                      ...
                                                                      multiplication_home_skills_coefs_per_player)
away_data_by_sets_athletes_distinct_skills_coef_multiplication<-cbind(away_data_by_sets_athletes_distinct_both_original_stds,
                                                                      ...
                                                                      multiplication_away_skills_coefs_per_player)
...
head(home_data_by_sets_athletes_distinct_skills_coef_multiplication[,colnames(home_data_by_sets_athletes_distinct_skills_coef_multiplication)%in%
                                                                      c("multiplication_home_skills_coefs_per_player",paste0("Home_",
                                                                                                                             c("failed_serves.x",
                                                                                                                               "poor_passes.x","failed_passes.x",
...
head(away_data_by_sets_athletes_distinct_skills_coef_multiplication[,colnames(away_data_by_sets_athletes_distinct_skills_coef_multiplication)%in%
                                                                      c("multiplication_away_skills_coefs_per_player",paste0("Away_",c("failed_serves.y","failed_passes.y",
                                                                                                                                       "blocked_att1.y","failed_att1.y",
                                                                                                                                       "perfect_att2.y", "failed_att2.y",
                                                                                                                                       "net_violation_blocks.y","failed_blocks.y")),
...
#---Log Scale
# home_data_by_sets_athletes_distinct_skills_coef_multiplication$impact_athletes_absence_exp_scale_std<-home_data_by_sets_athletes_distinct_skills_coef_multiplication$avg_lambda1_star*
#   ( exp(home_data_by_sets_athletes_distinct_skills_coef_multiplication$multiplication_home_skills_coefs_per_player_std)-1)/exp(home_data_by_sets_athletes_distinct_skills_coef_multiplication$multiplication_home_skills_coefs_per_player_std)
# 
# home_data_by_sets_athletes_distinct_skills_coef_multiplication$impact_athletes_absence_exp_scale<-home_data_by_sets_athletes_distinct_skills_coef_multiplication$avg_lambda1_star*
#   ( exp(home_data_by_sets_athletes_distinct_skills_coef_multiplication$multiplication_home_skills_coefs_per_player)-1)/exp(home_data_by_sets_athletes_distinct_skills_coef_multiplication$multiplication_home_skills_coefs_per_player)
# 
# 
# away_data_by_sets_athletes_distinct_skills_coef_multiplication$impact_athletes_absence_exp_scale_std<-away_data_by_sets_athletes_distinct_skills_coef_multiplication$avg_lambda2_star*
#   ( exp(away_data_by_sets_athletes_distinct_skills_coef_multiplication$multiplication_away_skills_coefs_per_player_std)-1)/exp(away_data_by_sets_athletes_distinct_skills_coef_multiplication$multiplication_away_skills_coefs_per_player_std)
# 
# away_data_by_sets_athletes_distinct_skills_coef_multiplication$impact_athletes_absence_exp_scale<-away_data_by_sets_athletes_distinct_skills_coef_multiplication$avg_lambda2_star*
#   ( exp(away_data_by_sets_athletes_distinct_skills_coef_multiplication$multiplication_away_skills_coefs_per_player)-1)/exp(away_data_by_sets_athletes_distinct_skills_coef_multiplication$multiplication_away_skills_coefs_per_player)
...
home_away_data_by_sets_athletes_distinct_skills_coef_multiplication_new<-rbind(home_data_by_sets_athletes_distinct_skills_coef_multiplication_new[c(
  "Team","Player",
  "avg_lambda_star",
  "impact_athletes_absence_log_scale",
...
athletes_impact<-home_away_data_by_sets_athletes_distinct_skills_coef_multiplication_new %>%
  ...
  summarize(avg_impact_absence_log_std = round(mean(impact_athletes_absence_log_scale_std, na.rm = T),2)) %>%
  arrange( desc(avg_impact_absence_log_std) )      %>% as.data.frame()      # Specify function
...
#---Filter out athletes with less total skills actions than the 50% (median) across all athletes
# and per Position

#--across all athletes
# athletes_impact_full_dataset_top_median_percentage<-athletes_impact_full_dataset[athletes_impact_full_dataset$sum_skill_actions_all_season>=
#                                                                                    median(athletes_impact_full_dataset$sum_skill_actions_all_season),]
# 
# athletes_impact_full_dataset_top_mean_percentage<-athletes_impact_full_dataset[athletes_impact_full_dataset$sum_skill_actions_all_season>=
#                                                                                  mean(athletes_impact_full_dataset$sum_skill_actions_all_season),]

#----- and per Position

# Average threshold of impact per Position
avg_per_Position<-athletes_impact_full_dataset %>% 
...
athletes_impact_full_dataset_top_mean_percentage_S<-athletes_impact_full_dataset[
  (athletes_impact_full_dataset$sum_skill_actions_all_season>=
     avg_per_Position$avg_total_skill_actions[avg_per_Position$Position=="S"] )&
...
athletes_impact_full_dataset_top_mean_percentage_S %>% 
  arrange(desc(avg_impact_absence_log_std)) 


athletes_impact_full_dataset_top_mean_percentage_S %>% 
  arrange(desc(avg_impact_absence_log_std),Position) %>% 
  group_by(Position) %>% slice(1:5)  %>% as.data.frame()

#--Position H above average skill actions
athletes_impact_full_dataset_top_mean_percentage_H<-athletes_impact_full_dataset[
  (athletes_impact_full_dataset$sum_skill_actions_all_season>=
     avg_per_Position$avg_total_skill_actions[avg_per_Position$Position=="H"] )&
...
athletes_impact_full_dataset_top_mean_percentage_L<-athletes_impact_full_dataset[
  (athletes_impact_full_dataset$sum_skill_actions_all_season>=
     avg_per_Position$avg_total_skill_actions[avg_per_Position$Position=="L"] )&
...
athletes_impact_full_dataset_top_mean_percentage_M<-athletes_impact_full_dataset[
  (athletes_impact_full_dataset$sum_skill_actions_all_season>=
     avg_per_Position$avg_total_skill_actions[avg_per_Position$Position=="M"] )&
...
athletes_impact_full_dataset_top_mean_percentage_0<-athletes_impact_full_dataset[
  (athletes_impact_full_dataset$sum_skill_actions_all_season>=
     avg_per_Position$avg_total_skill_actions[avg_per_Position$Position=="0"] )&
...
athletes_impact_full_dataset_top_mean_percentage_O<-athletes_impact_full_dataset[
  (athletes_impact_full_dataset$sum_skill_actions_all_season>=
     avg_per_Position$avg_total_skill_actions[avg_per_Position$Position=="O"] )&
...
write.csv(athletes_above_average_per_Position,file="NEW_ZDTS_skills_above_average_all_skill_actions_players_per_team_2016_2017.csv")
