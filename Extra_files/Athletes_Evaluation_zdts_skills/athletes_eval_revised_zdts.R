...
final_X_home_std<-X_home_std[,colnames(X_home_std)%in%c("Home_failed_serves_std","Home_poor_passes_std",
...
#----Standardization
home_skills_std$Home_failed_serves.x_std<-(home_data_by_sets_athletes_distinct$Home_failed_serves.x-mean(X_home$Home_failed_serves))/
...
home_skills_std$Home_failed_att1.x_std<-(home_data_by_sets_athletes_distinct$Home_failed_att1.x-mean(X_home$Home_failed_att1))/
...
#-------Home skills multiplied with coefficients
  ...
  multiplication_home_skills_coefs_per_player<-home_data_by_sets_athletes_distinct_based_std$Home_failed_serves_coef*
    home_data_by_sets_athletes_distinct_based_std$Home_failed_serves.x+
    home_data_by_sets_athletes_distinct_based_std$Home_poor_passes_coef*
    home_data_by_sets_athletes_distinct_based_std$Home_poor_passes.x+
    home_data_by_sets_athletes_distinct_based_std$Home_failed_passes_coef*
    home_data_by_sets_athletes_distinct_based_std$Home_failed_passes.x+
    home_data_by_sets_athletes_distinct_based_std$Home_blocked_att1_coef*
    home_data_by_sets_athletes_distinct_based_std$Home_blocked_att1.x+
    home_data_by_sets_athletes_distinct_based_std$Home_failed_att1_coef*
    home_data_by_sets_athletes_distinct_based_std$Home_failed_att1.x
...
#-------Away skills multiplied with coefficients
  ...
  multiplication_away_skills_coefs_per_player<--(
    away_data_by_sets_athletes_distinct$Away_failed_serves_coef*
      away_data_by_sets_athletes_distinct_based_std$Away_failed_serves.y+
      away_data_by_sets_athletes_distinct$Away_failed_passes_coef*
      away_data_by_sets_athletes_distinct_based_std$Away_failed_passes.y+
      away_data_by_sets_athletes_distinct$Away_blocked_att1_coef*
      away_data_by_sets_athletes_distinct_based_std$Away_blocked_att1.y+
      away_data_by_sets_athletes_distinct$Away_failed_att1_coef*
      away_data_by_sets_athletes_distinct_based_std$Away_failed_att1.y+
      away_data_by_sets_athletes_distinct$Away_perfect_att2_coef*
      away_data_by_sets_athletes_distinct_based_std$Away_perfect_att2.y+
      away_data_by_sets_athletes_distinct$Away_failed_att2_coef*
      away_data_by_sets_athletes_distinct_based_std$Away_failed_att2.y+
      away_data_by_sets_athletes_distinct$Away_blocked_net_violation_coef*
      away_data_by_sets_athletes_distinct_based_std$Away_net_violation_blocks.y+
      away_data_by_sets_athletes_distinct$Away_failed_blocks_coef*
      away_data_by_sets_athletes_distinct_based_std$Away_failed_blocks.y
  )
...
home_data_by_sets_athletes_distinct_skills_coef_multiplication$inverse_impact_athletes_absence_exp_scale_std<-home_data_by_sets_athletes_distinct_skills_coef_multiplication$avg_lambda1_star*(
  1-exp(-multiplication_home_skills_coefs_per_player_std) )
...
away_data_by_sets_athletes_distinct_skills_coef_multiplication$inverse_impact_athletes_absence_exp_scale_std<-away_data_by_sets_athletes_distinct_skills_coef_multiplication$avg_lambda2_star*(
...
athletes_impact<-home_away_data_by_sets_athletes_distinct_skills_coef_multiplication_new %>%
  ...
  arrange( desc(median_of_inverse_impact_absence_log_scale) )      %>% as.data.frame()      # Specify function
#---------------------------------------------------------------------------------------
...
athletes_impact_full_dataset_top_mean_percentage_S %>% 
  arrange(desc(median_of_inverse_impact_absence_log_scale)) 


athletes_impact_full_dataset_top_mean_percentage_S %>% 
  arrange(desc(median_of_inverse_impact_absence_log_scale),Position) %>% 
  group_by(Position) %>% slice(1:5)  %>% as.data.frame()
...
write.csv(athletes_above_average_per_Position,file="best_impact_athletes_2016_2017.csv")
