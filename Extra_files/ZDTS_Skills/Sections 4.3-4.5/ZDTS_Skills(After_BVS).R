...
final_X_home_std<-X_home_std[,colnames(X_home_std)%in%c("Home_perfect_passes","Home_very_good_passes",
                                                        "Home_poor_passes","Home_failed_passes",
                                                        "Home_blocked_att1")]
...
#load("ZDTS_only_Skills_after_BVS")
...
waic(log_lik_ZDTS_only_Skills_after_BVS)####237.6 18.6
loo(log_lik_ZDTS_only_Skills_after_BVS,
    r_eff=r_eff_log_lik_ZDTS_only_Skills_after_BVS)#  236.4 17.2
DIC_Gelman(deviance_ZDTS_only_Skills_after_BVS)#239.9
