...
load(file.choose())##ZDTS_only_Skills_after_BVS<-ZDTS_only_Skills_after_BVS
...
colnames(beta_home_params_ZDTS_only_Skills_after_BVS)<-c("(Home) perfect passes",
                                                         "(Home) very good passes",
                                                         "(Home) poor passes",
                                                         "(Home) failed passes",
                                                         "(Home) blocked att1")
...
unstd_beta_home_params_ZDTS_only_Skills_after_BVS<-sweep(std_beta_home_params_ZDTS_only_Skills_after_BVS,
                                                         MARGIN=2,apply(X_home[,colnames(X_home)%in%c("Home_perfect_passes",
                                                                                                      "Home_very_good_passes",
                                                                                                      "Home_poor_passes",
                                                                                                      "Home_failed_passes",
                                                                                                      "Home_blocked_att1")],2,sd), `/`)
...
xtable(t(rbind(apply(unstd_beta_home_params_ZDTS_only_Skills_after_BVS,2,mean),
...
xtable(t(rbind(apply(unstd_beta_away_params_ZDTS_only_Skills_after_BVS,2,mean),
