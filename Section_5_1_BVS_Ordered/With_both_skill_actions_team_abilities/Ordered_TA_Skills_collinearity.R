...
save(Full_ordered_team_abilities_skills,file="Full_ordered_team_abilities_skills_collinearity")

# Load the results from the full ordered logistic model (including both team abilities and all candidate variables).
load(file="Full_ordered_team_abilities_skills_collinearity")
...
etwd("C:/Users/vasileios palaskas/Desktop/Github folder/Bayesian_Variable_Selection_Volleyball/Section_5_1_BVS_Ordered/With_both_skill_actions_team_abilities")
#------------
...
save(gammas_matrix,file="BVS_Ordered_TA_Skills_gammas_collinearity")
save(betas_matrix,file="BVS_Ordered_TA_Skills_betas_collinearity")
load("BVS_Ordered_TA_Skills_gammas_collinearity")
load("BVS_Ordered_TA_Skills_betas_collinearity")
